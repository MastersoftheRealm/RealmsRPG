const damageTypeValues = {
    ...
    necrotic: { dieBase: 2, dieIncrease: 1 },
    acid: { dieBase: 2, dieIncrease: 1 },
    psychic: { dieBase: 4, dieIncrease: 1.5 },
    blunt: { dieBase: 2, dieIncrease: 1 },
    piercing: { dieBase: 2, dieIncrease: 1 },
    slashing: { dieBase: 2, dieIncrease: 1 }
};

export default damageTypeValues;
